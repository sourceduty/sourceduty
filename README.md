...
Alex Aldridge is a multifaceted talent as a self-taught designer, fan artist, and software developer. Sourceduty is a creative digital company that was established by Alex in late 2022. Sourceduty shares open-source codes, concept ideas and inspiration on GitHub.

Alex will be persistently maintaining Sourceduty and it's creative works without retiring. Sourceduty owns over 200 x 3D model assets and over 300 x GPT assets. This company is capable of producing and managing much more and it will be expanding into the deep future of the internet. Over the next decade, Sourceduty will continue to evolve, expanding its offerings and influence in the digital world.
...
| Sourceduty currently has `235` public repos sorted and listed below into `10` different categories. |
|-|
...
33. [Activity Balancer](https://github.com/sourceduty/Activity_Balancer)
...
4. [Search_Multiplier](https://github.com/sourceduty/Search_Multiplier)
5. [Ass_Detection](https://github.com/sourceduty/Ass_Detection)
6. [Huge_Cursor](https://github.com/sourceduty/Huge_Cursor)
7. [Video_Speed_Compression](https://github.com/sourceduty/Video_Speed_Compression)
8. [Battery_Level_Cursor](https://github.com/sourceduty/Battery_Level_Cursor)
9. [SMS_Web_Search](https://github.com/sourceduty/SMS_Web_Search)
10. [Web_Download_Queue](https://github.com/sourceduty/Web_Download_Queue)
11. [Dormant_Music_Files](https://github.com/sourceduty/Dormant_Music_Files)
12. [Smart_Web_Search](https://github.com/sourceduty/Smart_Web_Search)
13. [Sequenced_File_Folders](https://github.com/sourceduty/Sequenced_File_Folders)
14. [Vehicle Route](https://github.com/sourceduty/Predictive_Route)
15. [Business Blog](https://github.com/sourceduty/Business_Blog) 
16. [Regulated File Manager](https://github.com/sourceduty/Regulated_File_Manager)
17. [Chain Story](https://github.com/sourceduty/Chain_Story)
18. [Amazon_Premium](https://github.com/sourceduty/Amazon_Premium)
19. [Brand Footprint](https://github.com/sourceduty/Digital_Brand_Footprint)
20. [Dynamic_Text_Editor](https://github.com/sourceduty/Dynamic_Text_Editor)
21. [Windows_Deviance](https://github.com/sourceduty/Windows_Deviance)
22. [Multiuser Meeting Locator](https://github.com/sourceduty/Multiuser_Meeting_Locator)
23. [Repo_Card_Generator](https://github.com/sourceduty/Repo_Card_Generator)
24. [Contact_Verification](https://github.com/sourceduty/Contact_Verification)
25. [Voicemail-2-Text](https://github.com/sourceduty/Voicemail-2-Text)
26. [Trash_Capacity](https://github.com/sourceduty/Trash_Capacity)
27. [Advent Money App](https://github.com/sourceduty/Advent_Money)
28. [Recommended_Food](https://github.com/sourceduty/Recommended_Food)
29. [Cursor_Taskbar_Menu](https://github.com/sourceduty/Cursor_Taskbar_Menu)
30. [Encoded_Interactive_Graphic](https://github.com/sourceduty/Encoded_Interactive_Graphic_Format)
31. [Regional_Weather_Radar](https://github.com/sourceduty/Regional_Weather_Radar)
32. [Extensions](https://github.com/sourceduty/Extensions)
